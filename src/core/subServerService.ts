 ...
 */
export async function vlessOverWSHandler(request: any) {
 ...
 * @param {function} log 日志记录函数
 */
export async function socks5Connect(addressType: any, addressRemote: string | undefined, portRemote: number, log: (arg0: string) => void) {
	// @ts-ignore
